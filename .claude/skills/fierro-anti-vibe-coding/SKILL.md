...
| Gate | When | Catches |
|---|---|---|
| `pre-commit` | before commit | style, `mypy --strict`, stale contract, unsynced skills |
| CI | on the PR | ruff, `mypy --strict`, pytest against real Postgres, web build, compose smoke |
