...
- [`docs/estado.md`](docs/estado.md) — **empieza aquí si retomas**: qué está desplegado, qué no se ha probado nunca, y las trampas del entorno
...
| Infra nube | Vercel (PWA) + Neon (Postgres) + Cloud Run (API) | [`infra/`](infra/README.md). Sin aplicar todavía |
